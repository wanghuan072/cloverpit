<template>
  <div class="endings-page">
    ...
    <div class="page-content">
      ...
      <!-- Preparation Section -->
      <section id="preparation" class="section preparation">
        <div class="container">
      ...
      <!-- Bad Ending Section -->
      <section id="bad-ending" class="section bad-ending">
        <div class="container">
      ...
      <!-- Good Ending Section -->
      <section id="good-ending" class="section good-ending">
        <div class="container">
